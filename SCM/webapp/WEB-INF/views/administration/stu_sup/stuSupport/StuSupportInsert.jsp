...
<h5>학과 입력 페이지 입니다.</h5>
 	...
 	<form:form modelAttribute="business" method="post">
		<table class="major-table">
			<tr>
				<th>업체명</th>
				<td>
					<input type="text" name="bussName" value="${business.bussName }" placeholder="ex)편의점" />
			...
			<tr>
				<th>업체 업무</th>
				<td>
					<input type="text" name="bussJob" value="${business.bussJob }" placeholder="ex)편의용품 판매" />
