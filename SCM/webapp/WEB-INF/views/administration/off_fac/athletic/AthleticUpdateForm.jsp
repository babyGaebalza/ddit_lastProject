...
<h5>시설 수정 페이지 입니다.</h5>
 	...
 	<form:form modelAttribute="athletic" method="post" enctype="multipart/form-data" id="editForm">
		...
		<table class="major-table">
			...
			<tr>
				<th>수용인원수</th>
				<td>
					<input type="text" name="facNumber"  value="${athletic.facNumber}" /> 명
			...
			<tr>
				<th>예약가능여부</th>
				<td>
					<input type="text" name="facResult"  value="${athletic.facResult}" />
			...
			<tr>
				<th>시설사용비용</th>
				<td>
					<input type="text" name="facPayDisplay" class="facPay" value="${athletic.facPayDisplay}" /> 원
