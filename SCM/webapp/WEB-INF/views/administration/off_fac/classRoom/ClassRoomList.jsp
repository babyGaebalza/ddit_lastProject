			...
			<tr>
				<td colspan="6">
					<div class="search-align">
						...
						<div>
							<input type="button" value="신규강의실 등록" id="insertBtn" onclick="location.href='${cPath}/off_fac/classroomInsertForm.do'" class="linkBtn btn btn-secondary btn-sm"/> 
						</div>
