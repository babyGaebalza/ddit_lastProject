...
<div class="board-content-wrap">
	<div class="board-wrap m-top-110">
		...
		<div class="sub-txt">
			<div class="work-txt">
				<span>최종수정일 : ${notice.boardFdate}</span>
				<span>작성자 : ${notice.memNo}</span>
			</div>
			<div>
		    ...
		    <div class="file-wrap">
			 <c:forEach items="${notice.attatchList }" var="atch">
				...
				<div class="btn-wrap">		
				<c:url value="/common/lecturePage/noticeList.do" var="goBacktoListURL"></c:url>
				...
				<c:url value="/professor/lecturePage/noticeBoard/update.do" var="updateURL">
...
<form id="deleteForm" action="${cPath}/professor/lecturePage/noticeDelete.do" method="get">
