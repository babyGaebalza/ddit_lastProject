                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">학번/사번 찾기</h1>
                        </div>
                        <form:form class="user" id="sendCodeUIForm">
                            ...
                            <div class="form-group row">
	                            <div class="col-sm-6 mb-3 mb-sm-0">
	                                <input type="text" class="form-control form-control-user" name="memReg1"
	                                    placeholder="주민등록번호 앞자리" maxlength="6" required >
	                            </div>
	                            <div class="col-sm-6">
	                                <input type="password" class="form-control form-control-user" name="memReg2"
	                                    placeholder="주민등록번호 뒷자리 1자리" maxlength="1" required>
	                            </div>
                            </div>
                            
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="memTel"
                                    placeholder="휴대전화번호 입력(ex. 010-1234-5678)">
                            </div>
...
<form:form id="sendCodeForm" action="${pageContext.request.contextPath }/login/findId/sendCode.do" method="post" data-what="findId" data-send="N">
	<input type="hidden" name="memName"/>
	<input type="hidden" name="memReg1"/>
	<input type="hidden" name="memReg2"/>
