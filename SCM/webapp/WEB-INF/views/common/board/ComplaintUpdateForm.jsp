...
<h5>문의게시판 수정 페이지 입니다.</h5>
 
 	<form:form modelAttribute="complaint" method="post" enctype="multipart/form-data" id="editForm">
		...
		<table class="major-table">
			...
			<tr>
				...
				<td>
					${complaint.boardHits }
					<form:errors path="boardHits" element="span" cssClass="error" />
				</td>
			</tr>
