		...
		<h5 class="h5-title">마이 페이지</h5>
			<div class="profile-wrap">
				<div class="profile-img">
					<img src="data:image/*;base64,${manage.base64Image }"/>
				...
				<div class="profile-info-box m-left-20">
					...
					<div>
						<span>연락처</span>
						<input type="text" name="memTel" value="${manage.memTel }" style="width: 150px;"/>
		...
		<div class="m-top-20">
			...
			<div class="profile-info-box">
				<div class="line" style="border-top: 1px solid #cbccd5;">
					<span>주소</span>
					<input type="text" name="memAdd1" value="${manage.memAdd1 }" style="width: 500px;" />
						<form:errors path="memAdd1" element="span" cssClass="error" />
				</div>
				<div class="line">
					<span>상세 주소</span>
					<input type="text" name="memAdd2" value="${manage.memAdd2 }" style="width: 500px;"/>
					<form:errors path="memAdd2" element="span" cssClass="error" />
				</div>
				<div class="line">
					<span>이메일</span>
					<input type="text" name="memMail" value="${manage.memMail }" />
					<form:errors path="memMail" element="span" cssClass="error" />
				</div>
				<div class="line">
					<span>내/외국인</span>
					<c:if test="${manage.memNation eq 'N'}">
						내국인
					</c:if>
					<c:if test="${manage.memNation eq 'Y'}">
						외국인
					</c:if>
				</div>
				<div class="line">
				...
				<div class="line">
					<span>졸업여부</span>
					<c:if test="${manage.memGraduate eq 'N'}">
						졸업예정
					</c:if>
					<c:if test="${manage.memGraduate eq 'Y'}">
						졸업
					</c:if>
				</div>
				<div>
