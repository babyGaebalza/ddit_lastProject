	...
	<div class="profile-box">
		...
		<div class="m-top-20">
			...
			<div class="profile-info-box">
				...
				<div>
					<span>4대보험가입</span>
					<c:if test="${manage.memInsurance eq 'Y'}" >
						가입
					</c:if>
					<c:if test="${manage.memInsurance eq 'N'}" >
						미가입
					</c:if>
...
<form id="updateForm" action="${cPath }/common/member/manageMyPageUpdate.do" method="get" >
	<input type="hidden" name="memId" value="${manage.memId}" >
</form>
