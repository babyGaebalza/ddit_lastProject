		...
		<h5 class="h5-title">마이 페이지</h5>
			<div class="profile-wrap">
				<div class="profile-img">
					<img src="data:image/*;base64,${professor.base64Image }"/>
				...
				<div class="profile-info-box m-left-20">
					...
					<div>
						<span>연락처</span>
						<input type="text" name="memTel" value="${professor.memTel }" style="width: 150px;"/>
			...
			<div class="profile-info-box">
				<div class="line" style="border-top: 1px solid #cbccd5;">
					<span>주소</span>
					<input type="text" name="memAdd1" value="${professor.memAdd1 }" style="width: 500px;" />
						<form:errors path="memAdd1" element="span" cssClass="error" />
				</div>
				<div class="line">
					<span>상세 주소</span>
					<input type="text" name="memAdd2" value="${professor.memAdd2 }" style="width: 500px;"/>
					<form:errors path="memAdd2" element="span" cssClass="error" />
				</div>
				<div class="line">
					<span>이메일</span>
					<input type="text" name="memMail" value="${professor.memMail }" />
					<form:errors path="memMail" element="span" cssClass="error" />
				</div>
				<div class="line">
					<span>내/외국인</span>
					<c:if test="${professor.memNation eq 'N'}">
						내국인
					</c:if>
					<c:if test="${professor.memNation eq 'Y'}">
						외국인
					</c:if>
				</div>
				<div class="line">
				...
				<div class="line">
					<span>소속단과대</span>
					${professor.memCollege }
				</div>
				<div class="line">
					<span>입사일</span>
					${professor.memJoindate }
				</div>
				<div>
					<span>4대보험가입</span>
					<c:if test="${professor.memInsurance eq 'Y'}">
						가입
					</c:if>
					<c:if test="${professor.memInsurance eq 'N'}">
						미가입
					</c:if>
				</div>
			</div>
