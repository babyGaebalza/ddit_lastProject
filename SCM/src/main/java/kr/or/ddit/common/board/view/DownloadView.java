package kr.or.ddit.common.board.view;
...
public class DownloadView extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		File saveFile = new File(saveFolder, atch.getAttSavefilename());
		if(!saveFile.exists()) throw new FileNotFoundException("저장위치에 해당 파일이 없음.");
		
		String filename = URLEncoder.encode(atch.getAttOgfilename(), "UTF-8").replaceAll("\\+", " ");
